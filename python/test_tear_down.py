...
@patch("boto3.client")
def test_delete_all_versions(mock_boto_client):
...
@patch("boto3.client")
def test_delete_all_versions_no_versions(mock_boto_client):
    mock_s3 = mock_boto_client.return_value
    mock_paginator = mock_s3.get_paginator.return_value
...
@patch("boto3.client")
def test_delete_bucket(mock_boto_client):
    mock_s3 = mock_boto_client.return_value
...
@patch("boto3.client")
def test_delete_bucket_error(mock_boto_client):
    mock_s3 = mock_boto_client.return_value
